...
from src.models.mmgen.models.architectures.common import get_module_device
from src.models.mmgen.models.builder import MODULES, build_module
...
class StyleGANv3Generator(nn.Module):
    ...
    def forward(self,
        ...
        #print(ws.shape) 1x16x512
        
        if glean:
            out_img, bank_feature = self.synthesis(
            ws, glean, update_emas=update_emas, force_fp32=force_fp32)
        else:
